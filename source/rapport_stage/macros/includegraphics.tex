...
%   - Légende
%   - largeur en cm
\newcommand\includePhotoHorizontalCinqCm[2]{% 3 photos par ligne, orientation paysage
    \begin{figure}[!h]
        %\begin{subfigure}[b]{0.8\textwidth}
            %\includegraphics[angle=0,width=5cm,viewport=0 0 4000 3000,clip=true,keepaspectratio=true]{#1}
        \begin{center}
            \includegraphics[angle=0,width=5cm,clip=true,keepaspectratio=true]{#1}
        \end{center}
            %\caption{#2}
            %\label{#1}
        %\end{subfigure}
